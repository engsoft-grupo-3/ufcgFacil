...
export type Perfil = {
    ...
    cargaHorariaIntegralizada: string;
    creditosMinimos: string;
    creditosIntegralizados: string;
    creditosPercentuais: string;
    quantidadeMinima: string;
    quantidadeIntegralizada: string;
...
export async function alunoPerfil(cookieAuth)  {
